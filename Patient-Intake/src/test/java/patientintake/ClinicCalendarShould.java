...
class ClinicCalendarShould {
   ...
   class UpcomingAppointments {
      ...
      void whenThereAreSomePastAndFuture() {
         calendar.addAppointment("Jim", "Weaver", "avery", "07/27/2017 2:00 pm");
         calendar.addAppointment("Jim", "Weaver", "avery", "07/27/2018 2:00 pm");
         calendar.addAppointment("Jim", "Weaver", "avery", "07/27/2020 2:00 pm");
